...
export function ProjectCard({ project, featured = false }: ProjectCardProps) {
  ...
  const linkedCardClassName =
    `${cardBaseClassName} transform-gpu transition-all hover:-translate-y-3 hover:bg-surface-blue focus-visible:-translate-y-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-border`;
  const cardContent = (
    <>
